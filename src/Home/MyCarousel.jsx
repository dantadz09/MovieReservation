      ...
      <Carousel {...settings} ref={carouselRef}>  
        <div className='movie-container'>
          ...
          <div className='cinema-container' style={{ width: '50%', float: 'left' }}>
            ...
            <img src={require('../image/elemental.jpg')} alt="Elemental" style={{ width: '40%', float: 'left' }} />
              <img src={require('../image/NoHardFeelings.jpg')} alt="No Hard Feelings" style={{ width: '40%', float: 'left',marginLeft:'5px' }} />
            </div>
          </div>
        ...
        <div className='movie-container'>
          ...
          <div className='cinema-container' style={{ width: '50%', float: 'left' }}>
            <h2>Cinema 4</h2>
            <div className='movie-item'>
              <img src={require('../image/avengers.jpg')} alt="Avengers" style={{ width: '20%', float: 'left' }} />
              <img src={require('../image/annabelle.jpg')} alt="Annabelle" style={{ width: '20%', float: 'left' }} />
            </div>
          </div>
          <div style={{ clear: 'both' }}></div> 
        </div>
